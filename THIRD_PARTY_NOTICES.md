...
DITA Editor includes or uses open-source development dependencies listed in `bun.lock`. Their own licenses and notices remain controlling for those components. The packaged extension is built without production npm dependencies; the compiled bundle contains code produced from this repository and esbuild runtime helpers under the MIT License.

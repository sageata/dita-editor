...
const RUNTIME_MEDIA_FILES = new Set([
  ...
  'extension/media/canvas-command-bar-overflow.js',
  ...
  'extension/media/canvas-scroll-highlight.js',
  ...
  'extension/media/canvas-style-bridge.js',
  ...
  'extension/media/canvas-tooltips.js',
  'extension/media/canvas-zoom.js',
  'extension/media/canvas.js',
  'extension/media/content-theme.css',
  'extension/media/dita-inspector.svg',
  'extension/media/editor.css',
  'extension/media/properties-panel.js',
  'extension/media/properties-view.css',
  'extension/media/properties-view.js',
  'extension/media/styles-panel.js',
  'extension/media/styles-preview-popup.js',
  'extension/media/styles-view.css',
  'extension/media/styles-view.js',
  'extension/media/redline.css',
  'extension/media/redline-review.js',
  'extension/media/search-topics.svg',
  'extension/media/topic-search.css',
  'extension/media/topic-search.js',
]);
